...
I_a = simpson(f, a, b, N_a)   # I(N0)
I_b = simpson(f, a, b, N_b)   # I(N0/2)
I_c = simpson(f, a, b, N_c)   # I(N0/4)

I_Aitken = (I_b**2 - I_a * I_c) / (2 * I_b - (I_a + I_c))

p_est = np.log2(abs((I_c - I_b) / (I_b - I_a)))
